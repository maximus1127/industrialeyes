...
class Student extends Model
{
    ...
    public function passOrFail($student)
    {
        ...
        $grade2 = array('-1', '0', 'tk', 'k', 'TK', 'K', 'Tk', null, 'kn', 'KN', 'Kn');
    ...
    public function barcode(Student $student)
    {
        return '<img src="' . DNS1D::getBarcodePNGPath($student->student_number, 'C128') . '" alt="barcode"   />';
    }
}
